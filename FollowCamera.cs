...
public class FollowCamera : MonoBehaviour {
	...
	public Vector3 positionFPS;
	public Vector3 positionTPS;
	...
	void Update(){
			...
			mouseLook.y = Mathf.Clamp (mouseLook.y, -70, 90);
			...
			if (checkAction.actionPerform==true) {
				...
				playerCamera.transform.LookAt (lookPoint + lookOffset);
					...
					positionCam = targetPlayer.position - (camRotateX * (new Vector3 (0, -lookOffset.y, -lookOffset.z)));
